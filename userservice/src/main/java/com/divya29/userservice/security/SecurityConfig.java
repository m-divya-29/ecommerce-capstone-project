package com.divya29.userservice.security;
...
import com.divya29.userservice.security.services.CustomUserDetailsService;
...
public class SecurityConfig {
	...
	public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(AbstractHttpConfigurer::disable).cors(AbstractHttpConfigurer::disable)
				.authorizeHttpRequests(authorize -> authorize.requestMatchers("/api/clients/create").permitAll()
						.requestMatchers("/auth/signup").permitAll().requestMatchers("/users/**").permitAll()
